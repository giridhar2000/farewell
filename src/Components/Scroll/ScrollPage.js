...
function Pages() {
  ...
  return (
    <>
      <Page position={[-width * 1, 0, 0]} urls={['/img1.jpeg', '/img2.jpeg', '/img3.jpeg']} />
      <Page position={[width * 0, 0, 0]} urls={['/img4.jpeg', '/img5.jpeg', '/img6.jpeg']} />
      <Page position={[width * 1, 0, 0]} urls={['/img7.jpeg', '/img8.jpeg', '/img9.jpeg']} />
      <Page position={[width * 2, 0, 0]} urls={['/img10.jpeg', '/img2.jpeg', '/img3.jpeg']} />
      <Page position={[width * 3, 0, 0]} urls={['/img1.jpeg', '/img4.jpeg', '/img5.jpeg']} />
      <Page position={[width * 4, 0, 0]} urls={['/img6.jpeg', '/img7.jpeg', '/img8.jpeg']} />
    </>
  )
}
